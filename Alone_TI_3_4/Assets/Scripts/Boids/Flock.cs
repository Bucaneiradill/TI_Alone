...
public class Flock : MonoBehaviour
{
    ...
    void Start()
    {
        // Check if FlockManager.FM is not null before accessing its values
        ...
        {
            Debug.LogWarning("FlockManager.FM is not assigned!");
        }
    }
    ...
    void ApplyRules()
    {
        ...
        if(groupSize > 0)
        {
            vcenter = vcenter / groupSize + (FlockManager.FM.goalPos - this.transform.position); // ir em direção a um ponto
